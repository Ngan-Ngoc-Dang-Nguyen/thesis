...
#chapter("In-text Element Examples", image: image("../images/orange2.jpg"))
...
#chapter("Mathematics", image: image("../images/orange2.jpg"))
...
#chapter("Presenting Information and Results with a Long Chapter Title", image: image("../images/orange3.jpg"))
== Table
#index("Table")
...
#figure(
  image("../images/creodocs_logo.svg", width: 50%),
...
#figure(
  placement: bottom,
  image("../images/creodocs_logo.svg", width: 100%),
  caption: [Floating figure.],
) <figure1>

#my-bibliography( bibliography("../images/sample.bib"))

#make-index(title: "Index")

#show: appendices.with("Appendices")

#chapter("Appendix Chapter Title", image: image("../images/orange2.jpg"))
