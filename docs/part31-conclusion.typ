...
Từ những kết quả nghiên cứu trên, có nhiều hướng phát triển tiềm năng trong tương lai. Hai trong số đó là:
...
+ Chúng tôi cũng dự định nghiên cứu bài toán nâng cấp bán kính ổn định của điểm 1-center trên đồ thị cây. Chúng tôi dự định sẽ có có hướng tiếp cận tương tự bằng cách thiết lập cận dưới bán kính 